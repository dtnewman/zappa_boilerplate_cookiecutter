...
from {{ cookiecutter.app_name }}.test_utils import BaseTestCase
...
class TestViews(BaseTestCase):
    ...
    @mock.patch("{{ cookiecutter.app_name }}.public.views.flash")  # mocks out the calls to flash in views.py
    @mock.patch("{{ cookiecutter.app_name }}.utils.flash")  # mocks out the calls to flash (errors) in utils.py
    ...
    @mock.patch("{{ cookiecutter.app_name }}.utils.flash")
