...
class Local(Config):
    ...
    ENV = 'lcl'
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = os.environ.get("DB_CONNECTION_STRING") or 'postgresql://localhost:5432/{{ cookiecutter.app_name }}'
...
class Test(Config):
    TESTING = True
    DEBUG = True
    SQLALCHEMY_DATABASE_URI = os.environ.get("DB_CONNECTION_STRING") or 'postgresql://localhost:5432/{{ cookiecutter.app_name }}_test'
